"""Experimental face-clustering workflow.

Prototype for mesh face clustering and sparse distance matrix experiments.
...
def main():
    ...
    # 提取线段和目标面
    data_path = str(get_path("line_face_output", create_parent=True))#使用脚本line_face_extraction.py来转存文件
